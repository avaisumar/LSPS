        ...
        >
          ...
          <div className='d-flex align-items-center table-header-actions'>
            ...
            <Button className='add-new-user' color='primary' onClick={toggleSidebar}>
              {tabtype === "designation" ? "Add New Designation" : "Add New User"}
            </Button>
          </div>
        </Col>
      </Row>
...
const UsersList = () => {
  ...
  const filteredData = store?.allData?.filter(item => {
  ...
  return (
    <Fragment>
      ...
      <Sidebar open={sidebarOpen} toggleSidebar={toggleSidebar}  tabtype={tabtype} />
    </Fragment>
  )
}
